import { getUserPostCount } from "./postAnalyze.ts";
import config from '../_config.ts';
import { batchRun } from "./batchRunner.ts";
import { updateSitemap as updateMainSitemap, clear as clearMainSitemap } from "./mainSitemap.ts";
...
// start();
cron.schedule(config.cron, start);